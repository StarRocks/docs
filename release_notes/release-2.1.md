...
- A deadlock problem may occur when an FE node collects information from a global dictionary for low-cardinality optimization. [#3839]( https://github.com/StarRocks/starrocks/issues/3839)
